...
lyr_OSMStandard_0.setVisible(true);lyr_Kota_BandungADMNew_1.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_Kota_BandungADMNew_1];
...
lyr_Kota_BandungADMNew_1.set('fieldLabels', {'NAMOBJ': 'no label', 'REMARK': 'no label', 'LCODE': 'no label', 'WADMKC': 'hidden field', 'WADMKK': 'no label', 'WADMPR': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'inline label - always visible', });
