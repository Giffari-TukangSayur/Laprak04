...
map.getView().fit([11951995.554641, -789666.102045, 12021273.939049, -754335.685900], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Administrasi Batas Wilayah Kota Bandung</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (547 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini menyajikan batas administrasi Kota Bandung hingga tingkat kecamatan. Setiap kecamatan ditampilkan dengan warna berbeda menggunakan gradasi merah dan coklat guna mempertegas batas antarwilayah secara visual. Kota Bandung dikelilingi oleh kawasan hijau yang merupakan wilayah Kabupaten Bandung dan daerah perbatasan lainnya, sehingga batas kota terlihat jelas dan mudah diidentifikasi. Peta ini berfungsi sebagai acuan spasial untuk mengenali persebaran dan posisi geografis masing-masing kecamatan dalam lingkup administratif Kota Bandung.';
            }
